...
In the count based scenario, results were similar. Both approaches perform worse than Normal base datasets. Two-step factor analysis has more outliers with much higher false positive rates. GSFA has more outliers with higher false negative rate.
