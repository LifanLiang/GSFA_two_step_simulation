...
I compared the unguided with the guided GSFA on 300 simulation datasets (Normal based) with factor density 0.5. Guided GSFA has lower FPR and similar FNR.
...
In the count based scenario, results were similar. Both approaches perform worse than Normal base datasets. Two-step factor analysis has more outliers with much higher false positive rates. GSFA has more outliers with higher false negative rate. Overall, the benefit outweights the loss. This is particularly true when a guide affects multiple factors (e.g. guide 6 in the simulation).
